...
class ClientPacketHandler {
  ...
  handlePlayerInventorySlot(packet: Packet): boolean {
    if ((this.currentClient.state === ClientStates.FreshConnection
        || this.currentClient.state === ClientStates.ConnectionSwitchEstablished)
    ...
    const disabled = (this.currentClient.state === ClientStates.FreshConnection
      || this.currentClient.state === ClientStates.ConnectionSwitchEstablished)
      && this.currentClient.server.isSSC;
    return disabled;
  }
